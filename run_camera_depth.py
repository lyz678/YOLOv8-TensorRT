...
class DepthEngine:
    ...
    def postprocess(self, depth: np.ndarray) -> np.ndarray:
        ...
        depth_display = cv2.applyColorMap(depth_normalized, cv2.COLORMAP_INFERNO)q
...
# python3 run_camera_depth.py --sensor_id 0 --trt_engine_path depth_anything_vits14_308.trt --H 308 --W 308


# trtexec --onnx=depth_anything_vits14.onnx --saveEngine=depth_anything_vits14_308.trt --shapes=image:1x3x308x308 --fp16 --workspace=4096 --verbose
